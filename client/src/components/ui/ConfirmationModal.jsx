        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center p-4 sm:items-center">
          ...
          <motion.div
            ...
            className={cn(
              ...
              "border border-ink-200/60 bg-white/95 shadow-elevation-4 backdrop-blur-xl",
              "dark:border-white/10 dark:bg-[#0d1526]/98",
            )}
          >
            {/* Close */}
            <button
              ...
              className="absolute right-3 top-3 rounded-lg p-1.5 text-ink-400 transition hover:bg-ink-100 hover:text-ink-700 dark:hover:bg-white/10 dark:hover:text-ink-200"
            >
              <X className="h-4 w-4" />
            </button>
