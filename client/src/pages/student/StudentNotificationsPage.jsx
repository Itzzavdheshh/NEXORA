...
function NotificationsEmptyState({ filter, onClear }) {
  ...
  if (filter === "all") {
    return (
      ...
      >
        <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-accent-primary/10 text-accent-primary shadow-sm dark:bg-accent-primary/10 dark:text-accent-primary">
        ...
        <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-ink-500 dark:text-ink-300">
          Booking confirmations, mentor updates, and important announcements will show up right here. Nothing to miss.
        </p>
      </motion.div>
    );
  }
